<?php
/**
 * In method getMailingContent(), it converts new lines into BR tags when displaying an HTML email, which I believe is wrong
 * So this file updates that
 * 
 */
...
class CRM_Mailing_BAO_Mailing extends CRM_Mailing_DAO_Mailing {
  ...
  static function &getRecipientsCount($job_id, $mailing_id = NULL, $mode = NULL) {
	...
	/**
	 * It looks as though this function actually creates a list of contacts in the civicrm_group_contact_cache
	 * rather than returning anything, unlike the name implies
	 * Once run, check the contact_cache for results
	 */
